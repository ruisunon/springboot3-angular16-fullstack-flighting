package io.rxs.fligh.reactive.auth;
...
public class JwtTokenProvider {
    ...
    private String jwtExpirationMills;
    ...
    public void init() {
        var secret = Base64.getEncoder()
                .encodeToString(this.jwtSecretKey.getBytes());
    ...
    public String createToken(Authentication authentication) {
        ...
        Date now = new Date();
        Date validity = new Date(now.getTime() + this.jwtExpirationMills);
