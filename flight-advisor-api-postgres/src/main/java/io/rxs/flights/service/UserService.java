...
import io.rxs.flights.infra.mapper.UserMapper;
...
public class UserService implements UserDetailsService {
     ...
     */
    public void invalidateRefreshTokenById(Long userId) {
     ...
     */
    public void updatePassword(Long userId, ChangePasswordRequest changePassRequest) {
